  ...
  return (
    <footer id="contact" className="relative min-h-screen flex items-center py-16 sm:py-24 xl:py-32 px-4 sm:px-6 xl:px-8 bg-white" aria-labelledby="contact-heading">
      <div className="max-w-5xl xl:max-w-6xl 2xl:max-w-7xl 3xl:max-w-8xl mx-auto w-full">
        ...
        >
          <div className="relative overflow-hidden rounded-2xl bg-slate-900 px-6 sm:px-10 xl:px-14 py-5 sm:py-6 xl:py-8 text-center w-full sm:w-auto">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-brand-500/10 border border-brand-500/20 mb-3">
                ...
                <span className="text-brand-400 text-[9px] sm:text-[10px] xl:text-xs 2xl:text-sm font-medium">Inspire 2026 校招 · AI 产品经理候选人</span>
              </div>
              <div className="text-[18px] sm:text-[20px] xl:text-[24px] 2xl:text-[28px] font-bold text-white tracking-tight">吴倩 · Olivia Wu</div>
            </div>
          </div>
        </motion.div>
        ...
        {/* 联系方式 */}
        <motion.div
          className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 xl:gap-6 max-w-sm sm:max-w-2xl xl:max-w-3xl mx-auto mb-12 sm:mb-16"
        ...
        {/* 底部 */}
        <div className="pt-5 sm:pt-6 border-t border-slate-100 text-center text-[10px] sm:text-[11px] xl:text-xs 2xl:text-sm text-slate-300">
